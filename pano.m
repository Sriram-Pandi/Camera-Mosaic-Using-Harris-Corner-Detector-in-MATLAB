...
buildingScene = imageDatastore(["img1.jpg","img2.jpg","img3.jpg","img4.jpg","img5.jpg","img6.jpg","img7.jpg"]);
...
grayImage = im2gray(I);
[y,x,m] = harris(grayImage, 2000, 'tile', [2 2], 'disp');
...
for n = 2:numImages
    ...
    tforms(n) = estgeotform2d(matchedPoints, matchedPointsPrev,"affine","Confidence",92,'MaxNumTrials', 2000);
